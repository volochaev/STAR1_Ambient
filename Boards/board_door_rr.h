 ...
 * @brief Hardware mapping for Rear-Right door ambient zones.
 *
 * Тут описываем:
...
#define RR_STRIP_LEDS      100u   // длинная линия по двери
#define RR_HANDLE_LEDS     8u     // ручка открывания
#define RR_STORAGE_LEDS    6u     // ниша/карман
#define RR_FOOTWELL_LEDS   10u    // подсветка ног
